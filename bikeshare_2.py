...
def time_stats(df):
    ...
    Args:
        (dataframe) df - Dataframe with 'Start Time' column.
    Returns:
        print time stats statistcs
...
def station_stats(df):
    ...
    Args:
        (dataframe) df - Dataframe with 'Start Station' and 'End Station' columns.
    Returns:
        print station stats statistcs
    """
    ...
    while True:
        ...
        while True:
            ...
            if restart.lower() == 'no':
                ...
                print('Humm... Coundn\'t understand that. Please check if our answer is "yes" or "no"\n')
